...
import {
    Button, Modal, ListGroup, ListGroupItem, Form, FormControl, ControlLabel,
    FormGroup
...
const FileUploader = createReactClass({
    ...
    handleSignAndSubmit() {
        ...
        const { currentFile, sizeKb, sharingKey, signingKey, privateChecked, fileContent, address} = this.state
        ...
        const metadata = api.createMetaData(file, sizeKb, fileDate, address, sharingKey, signingKey, privateChecked)
    ...
    render() {
        const { files, privateChecked, signingKey, sharingKey, currentFile, showModal } = this.state
                ...
                <Modal show={showModal} onHide={this.handleClose}>
                    ...
                    <Modal.Body className="modal-body">
                        ...
                        <FormGroup controlId="formSharingKey">
                            ...
                            <p className='help-text'>Save this key, it will be used to share access to this file.</p>
                            <FormControl
                                readOnly
                                type="text"
                                value={sharingKey}
                        ...
                        <FormGroup controlId="formSharingKey">
                            <ControlLabel>Signing Key</ControlLabel>
                            <p className='help-text'>If specified, this key will be required to upload a signed version of the file.</p>
                            <FormControl
                                type="text"
                                value={signingKey}
                        ...
                        <FormGroup controlId="formAddress">
                            ...
                            <p className='help-text'>This will restrict access to your file's history and metadata.</p>
                            <FormControl
                                type="checkbox"
